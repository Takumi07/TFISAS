<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Maestra.Master" CodeBehind="AgregarProducto.aspx.vb" Inherits="TFISAS.AgregarProducto" %>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="panel panel-verde">
                    <div class="panel-heading">
                        <asp:Label ID="lbl_NuevoProducto" runat="server">Nuevo Producto</asp:Label>
                    </div>
                        ...
                        <div class="col-md-12 col-md-offset-2">
                            <div class="form-horizontal" role="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                        <asp:Label ID="lbl_TipoProducto" class="control-label Negrita" runat="server" Text="Tipo de Producto"></asp:Label>
                                        <asp:DropDownList ID="ddl_TipoProducto" CssClass="form-control" runat="server"></asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4" style="margin-left: -22px"">
                                        ...
                                        <asp:RangeValidator 
                                            ...
                                            Text="*"
                                            MinimumValue ="1"
                                            MaximumValue="9999999999999999999999999"
