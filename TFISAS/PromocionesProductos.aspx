<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Maestra.Master" CodeBehind="PromocionesProductos.aspx.vb" Inherits="TFISAS.PromocionesProductos" %>
            ...
            <div class="col-xs-6 col-md-6 col-md-offset-3" id="SinPromocion" runat="server">
                <a href="NuestrosProductos.aspx" class="thumbnail">
                    ...
                    <div class="caption text-center">
                        <h3>
                            <asp:Label ID="lbl_SinPromos" runat="server" CssClass="form-group" Text="Por el momento no poseemos promociones especiales para usted"></asp:Label>
                        </h3>
                    </div>
                </a>
            </div>
