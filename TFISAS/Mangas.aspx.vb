Public Class Mangas
    ...
    Private Sub obtenerProductos(Optional ByVal paramPagina As Integer = 1)
        Try
            ...
            MiListaMangas = MiMangaBLL.ListarProductosManga
            generarpaginacion(MiListaMangas.Count)
            ...
            Dim Flag = 1
            For Each miproducto As Entidades.Producto In MiListaMangas
            ...
            Ocultacion = MiListaMangas.Count - PosicionHasta
